...
<head>
    ...
    <title>EVALUACION DE CLIMA LABORAL</title>
</head>
...
<body>
  <table width="100%" border="1">
    ...
    <table width="100%" border="1" align="center">
     <tr>
         <td style="font-weight: bold"><CENTER>FECHA :</CENTER></td>
        <td style="font-weight: bold"><CENTER>17/07/17</CENTER></td>
            <td style="font-weight: bold"><CENTER>VERSION : 01</CENTER> </td>
            <td style="font-weight: bold"><CENTER>01</CENTER> </td>
            <td style="font-weight: bold"><CENTER>CODIGO</CENTER></td>
            <td style="font-weight: bold"><CENTER>F-RH-008</CENTER></td>
        </tr>
    ...
    <table width="100%" border="0">
        ...
        @if($cabecerapdf) @foreach($cabecerapdf as $data)
        <tr>
...
<table width="100%" border="0">
  ...
  <tr>
    ...
    <td style="text-align: justify"><center>A continuación encontrará una serie de enunciados relacionados  con situaciones o características de su ámbito laboral, cada una tiene 4 opciones para responder de acuerdo a lo que describa mejor su relación /experiencia con  Industrias Triveca. Lea cuidadosamente cada pregunta y coloque su respuesta de acuerdo a las siguientes opciones:</center> </td>
...
<table width="100%" border="1" align="left">
  <tr>
    ...
    <td><center>PUNTUACIÓN</center></td>
  </tr>
     @if($cuerpopdf) @foreach($cuerpopdf as $data2)
  <tr>
