<html lang="en">
<head>
  <title>Resultados de clima Laboral</title>
  <meta charset="utf-8">
...
<div class="container">
    <center><h2>Resultados de Clima Laboral</h2></center>
   
    <br>   </br>
  
  
  <form class="form-horizontal" action="{{ route('Reporte2cont') }}" method="get"  >
      {{csrf_field()}}
<fieldset>
...
<div class="form-group">
  <label class="col-md-2 control-label" for="selectbasic">Sedes</label>
  <div class="col-md-4">
...
?>
   <div class="form-group">
  <label class="col-md-1 control-label" for="txtanio2">Año</label>  
  <div class="col-md-2">
  <input id="txtanio" name="txtanio2" placeholder="Solo el año" class="form-control input-md" required="" type="text" value= <?php echo $vaño  ?> >
  </div>
...
<!-- Button -->
  ...
  <label class="col-md-0 control-label" for="btnbuscar"></label>
  
    <button id="btnbuscar" name="btnbuscar" class="btn btn-primary">Buscar</button>
  

 <label class="col-md-5 control-label" for="btnexport"></label>
<a 
      href="{{ route('exportexcelCL',  
            [
                !empty($_GET['selectSede']) ? $_GET['selectSede'] : 'vacio', 
                !empty($_GET['txtanio2']) ? $_GET['txtanio2'] : '2017', 
                 ]) }}"
