...
<center>
    ...
    <div class="alert alert-success"> Sus datos han sido actualizados correctamente. </div>
...
<center>
    ...
    <IMG SRC="{{ asset('imagenes/indice.png') }}">
    <br></br>
    <a href="../empleado/listEditemp">Volver a revisar mis Datos</a>
</center>
