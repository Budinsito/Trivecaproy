...
$("#fecha").datepicker();
        ...
        <form class="form-horizontal" action="{{ route('Grabanuevohijo',$id) }}" method="POST"   >
<fieldset>
{{csrf_field()}}
<!-- Form Name -->
<center><legend>Agregar hijo de empleado</legend></center>
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="txtnombre" name="txtnombre" placeholder="" class="form-control input-md" required="" type="text" >
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="txtapellidos" name="txtapellidos" placeholder="" class="form-control input-md" required="" type="text" >
...
<div class="form-group">
  ...
  <div class="col-md-2">
  <input id="fecha" name="txtfnacimiento" placeholder="" class="form-control input-md" required="" type="text" >
...
<div class="form-group">
  ...
  <div class="col-md-3">
  <input id="txtdni" name="txtdni" placeholder="" class="form-control input-md" type="text" >
